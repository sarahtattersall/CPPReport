\subsection{Challenges}
  ...
  \subsubsection{Multi Departmental}
    ...
    \begin{itemize}
      ...
      \item Finally in order to not make our website too specific to any single department we had to leave the events and placement forms as quite general. Therefore we opted to use a notification system in order to acheive our this objective. As seen department administrators can set a note that will appear on the top of forms with any extra content they may need.
    \end{itemize}
